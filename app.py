...
<meta name="apple-mobile-web-app-title" content="GPT MKT">


<!-- RESTORE MAIN UI CSS - giữ nguyên menu trái, card, màu sắc, icon -->
<style id="mkt-main-ui-restore-css">
:root{--bg:#eef4ff;--dark:#0f172a;--dark2:#111827;--blue:#2563eb;--purple:#7c3aed;--green:#16a34a;--gold:#f59e0b;--red:#ef4444;--text:#0f172a;--muted:#64748b;--line:#e2e8f0;--card:#ffffff}
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;font-family:'Manrope','Inter','Segoe UI',Arial,sans-serif;background:radial-gradient(circle at top left,#dbeafe 0,#eef4ff 30%,#f8fafc 70%);color:var(--text);font-size:14px;line-height:1.55;padding-bottom:120px}a{color:#2563eb;text-decoration:none}button,input,select,textarea{font-family:inherit}button{border:0;border-radius:12px;padding:10px 14px;font-weight:900;cursor:pointer;background:linear-gradient(135deg,#2563eb,#7c3aed);color:#fff;box-shadow:0 10px 24px rgba(37,99,235,.18);transition:.18s ease}button:hover{transform:translateY(-1px);box-shadow:0 14px 30px rgba(37,99,235,.28)}button.secondary,.secondary{background:#fff!important;color:#2563eb!important;border:1px solid #bfdbfe!important;box-shadow:0 8px 20px rgba(15,23,42,.08)!important}input,select,textarea{border:1px solid #cbd5e1;border-radius:12px;padding:10px 12px;background:#fff;color:#0f172a;outline:none;max-width:100%}textarea{min-height:90px;resize:vertical}input:focus,select:focus,textarea:focus{border-color:#2563eb;box-shadow:0 0 0 3px rgba(37,99,235,.12)}
.v2-topbar{position:sticky;top:0;z-index:50;background:rgba(255,255,255,.82);backdrop-filter:blur(18px);border-bottom:1px solid rgba(226,232,240,.9);padding:12px 22px}.v2-brand-row{display:flex;align-items:center;justify-content:space-between;gap:12px}.v2-brand-title{font-size:20px;font-weight:1000;color:#1e1b4b;letter-spacing:-.02em}.v2-brand-sub{font-size:12px;color:#64748b;font-weight:800}.v2-status-pill{background:linear-gradient(135deg,#dcfce7,#bbf7d0);color:#166534;border:1px solid #86efac;border-radius:999px;padding:7px 12px;font-weight:1000;font-size:12px}
.live-trust-bar{display:flex;align-items:center;gap:8px;margin:14px auto 0;max-width:1480px;background:#0f172a;color:#e0f2fe;border:1px solid rgba(125,211,252,.25);border-radius:999px;padding:9px 15px;font-weight:900;box-shadow:0 12px 35px rgba(15,23,42,.12)}.live-dot{width:9px;height:9px;background:#22c55e;border-radius:50%;box-shadow:0 0 0 4px rgba(34,197,94,.16),0 0 16px #22c55e;display:inline-block}.layout{max-width:1480px;margin:14px auto 40px;display:grid;grid-template-columns:292px minmax(0,1fr);gap:18px;padding:0 18px}.sidebar{position:sticky;top:78px;align-self:start;max-height:calc(100vh - 92px);overflow:auto;background:linear-gradient(180deg,#0f172a,#111827);border:1px solid rgba(148,163,184,.25);border-radius:28px;padding:18px;color:#e5e7eb;box-shadow:0 28px 70px rgba(15,23,42,.28)}.logo{font-size:24px;line-height:1.05;font-weight:1000;color:#fff;letter-spacing:-.03em}.subtitle{margin-top:7px;color:#93c5fd;font-weight:800;font-size:12px}.nav{margin-top:14px}.v2-nav-title{font-size:11px;color:#94a3b8;font-weight:1000;letter-spacing:.09em;margin:18px 8px 8px;text-transform:uppercase}.v2-nav-link{position:relative;display:grid;grid-template-columns:28px 1fr auto;align-items:center;gap:8px;color:#e5e7eb;background:rgba(255,255,255,.055);border:1px solid rgba(255,255,255,.07);border-radius:16px;padding:10px 10px;margin:7px 0;font-weight:900;transition:.18s ease}.v2-nav-link:hover,.v2-nav-link.active{background:linear-gradient(135deg,rgba(37,99,235,.75),rgba(124,58,237,.75));border-color:rgba(191,219,254,.5);transform:translateX(3px);box-shadow:0 12px 28px rgba(37,99,235,.22)}.v2-nav-ico{font-size:18px;text-align:center}.v2-nav-text{font-size:13px;white-space:normal}.v2-nav-tag{background:rgba(250,204,21,.16);color:#fde68a;border:1px solid rgba(250,204,21,.25);border-radius:999px;padding:3px 8px;font-size:10px;font-weight:1000}.v2-side-card{background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.11);border-radius:18px;padding:12px;margin-top:14px;color:#e5e7eb;line-height:1.55;font-size:12px}.main{min-width:0}.top-hero,.panel{background:rgba(255,255,255,.94);border:1px solid rgba(226,232,240,.9);border-radius:28px;padding:22px;margin-bottom:18px;box-shadow:0 24px 70px rgba(15,23,42,.10)}.top-hero{background:linear-gradient(135deg,#ffffff,#eef2ff 55%,#f5f3ff)}h1,h2,h3{letter-spacing:-.025em;color:#111827}h1{font-size:34px;line-height:1.12;margin:0 0 10px}h2{font-size:24px;margin:0 0 10px}h3{margin:0 0 8px}.small,.mini{font-size:12px;color:#64748b;font-weight:700}.light{color:#94a3b8}.success{background:#dcfce7;color:#166534;border:1px solid #86efac;border-radius:14px;padding:12px;margin:10px 0;font-weight:800}.error{background:#fee2e2;color:#991b1b;border:1px solid #fecaca;border-radius:14px;padding:12px;margin:10px 0;font-weight:800}.grid,.app-quick-grid,.module-hub,.v3-feature-grid,.v5-seller-grid,.v9-grid,.analytics-grid,.library-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:14px}.grid4{display:grid;grid-template-columns:repeat(auto-fit,minmax(170px,1fr));gap:14px}.app-quick-card,.module-card,.v3-feature-card,.v5-tool-card,.v9-card,.template-card,.lock-card,.activity-card,.analytics-box,.analytics-kpi,.qr-card,.premium-plan,.v4-trust-card,.v4-success-card,.v4-proof-box,.v4-value-received,.gf-box,.page-item{background:#fff;border:1px solid #e2e8f0;border-radius:22px;padding:16px;box-shadow:0 14px 36px rgba(15,23,42,.08);transition:.18s ease}.app-quick-card:hover,.module-card:hover,.premium-plan:hover{transform:translateY(-3px);box-shadow:0 22px 50px rgba(37,99,235,.16);border-color:#bfdbfe}.app-quick-card{cursor:pointer}.app-ico,.icon{width:42px;height:42px;border-radius:16px;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#dbeafe,#ede9fe);font-size:22px;margin-bottom:10px}.app-quick-card b,.module-card h3{display:block;font-size:16px;color:#1e1b4b}.app-quick-card span,.module-card p{display:block;color:#64748b;font-weight:700;font-size:13px}.module-pill,.value-badge,.v3-premium-badge,.v5-status-pill{display:inline-block;margin-top:10px;border-radius:999px;padding:6px 10px;background:#eff6ff;color:#1d4ed8;font-size:12px;font-weight:1000}.v3-kpi-title{background:#111827;color:#dbeafe;border-radius:18px;padding:12px 14px;margin-top:16px;font-weight:900}.stat{background:#fff;border:1px solid #e2e8f0;border-radius:20px;padding:15px;box-shadow:0 12px 32px rgba(15,23,42,.07)}.stat span{font-size:12px;color:#64748b;font-weight:1000;text-transform:uppercase}.stat b{display:block;font-size:22px;margin:5px 0;color:#1e1b4b}.stat small{color:#64748b;font-weight:700}.v4-trust-grid,.v4-success-grid,.v4-value-grid,.v4-pricing-stats,.analytics-kpi-grid,.gf-grid,.gf-grid-3{display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:12px;margin:14px 0}.v4-trust-card b{font-size:24px;color:#2563eb;display:block}.v4-trust-card span{font-weight:800;color:#64748b}.hero-actions,.payment-actions{display:flex;flex-wrap:wrap;gap:10px;margin-top:14px}.module-section{display:none}.module-section.active-module{display:block}.section-open-note{display:inline-block;background:#eef2ff;color:#3730a3;border:1px solid #c7d2fe;border-radius:999px;padding:7px 12px;font-size:12px;font-weight:1000;margin-bottom:10px}.history,.preview,.preview-content{background:#0f172a;color:#e5e7eb;border-radius:18px;padding:14px;white-space:pre-wrap;overflow:auto;border:1px solid #1e293b}.history{max-height:360px}.preview-head{font-weight:1000;margin-bottom:8px}.preview-name{color:#93c5fd}.page-list{display:grid;gap:8px;margin:12px 0}.page-item{display:flex;align-items:center;gap:10px;padding:12px}.page-item input{width:auto}.bank-info,.payment-alert,.premium-note-box,.v4-save-box,.v5-focus-box,.gf-warning,.free-progress{border-radius:18px;padding:14px;margin:12px 0;border:1px solid #dbeafe;background:#eff6ff;color:#1e3a8a;font-weight:800}.v4-save-box.gold{background:#fffbeb;border-color:#fde68a;color:#92400e}.payment-modal,.premium-center{display:none;position:fixed;inset:0;background:rgba(15,23,42,.72);z-index:2147482000;align-items:center;justify-content:center;padding:18px}.payment-inner{max-width:940px;width:100%;max-height:92vh;overflow:auto;background:#fff;border-radius:28px;box-shadow:0 35px 100px rgba(15,23,42,.45)}.payment-head{display:flex;align-items:flex-start;justify-content:space-between;gap:14px;padding:20px 24px;background:linear-gradient(135deg,#2563eb,#7c3aed);color:#fff}.payment-head h2{color:#fff}.payment-close{background:rgba(255,255,255,.16)!important;color:#fff!important;border:1px solid rgba(255,255,255,.25)!important}.payment-body{padding:22px}.payment-detail,.payment-form-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:14px}.pay-amount{font-size:30px;font-weight:1000;color:#2563eb}.premium-pricing-pro{background:linear-gradient(135deg,#f8fafc,#eef2ff);border:1px solid #dbeafe;border-radius:28px;padding:20px;margin-top:14px}.premium-title{text-align:center;font-size:30px;font-weight:1000;color:#1e1b4b}.premium-grid-pro{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:16px}.premium-plan{position:relative}.premium-plan.featured{border:2px solid #7c3aed;box-shadow:0 24px 60px rgba(124,58,237,.18)}.plan-ribbon{position:absolute;right:14px;top:14px;background:linear-gradient(135deg,#f59e0b,#ef4444);color:#fff;border-radius:999px;padding:5px 10px;font-size:11px;font-weight:1000}.plan-name{font-size:18px;font-weight:1000;color:#1e1b4b}.plan-price{font-size:28px;font-weight:1000;color:#2563eb;margin:8px 0}.plan-desc{color:#64748b;font-weight:700}.benefit-list{padding-left:18px;line-height:1.8}.benefit-list li{font-weight:800}.benefit-list .open{color:#166534}.benefit-list .locked{color:#991b1b}.plan-button{width:100%;margin-top:12px}.kanban-board{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:12px}.kanban-col{background:#f8fafc;border:1px dashed #cbd5e1;border-radius:18px;padding:12px;min-height:150px}.kanban-card{background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:10px;margin:8px 0;box-shadow:0 8px 18px rgba(15,23,42,.06)}table,.v5-table,.gf-table{width:100%;border-collapse:separate;border-spacing:0;background:#fff;border:1px solid #e2e8f0;border-radius:18px;overflow:hidden}th,td{padding:10px;border-bottom:1px solid #e2e8f0;text-align:left;vertical-align:top}th{background:#eff6ff;color:#1e3a8a;font-weight:1000}.analytics-row{display:grid;grid-template-columns:1fr 1fr;gap:14px}.analytics-box.full{grid-column:1/-1}.empty-analytics{padding:16px;color:#64748b;font-weight:800;background:#f8fafc;border-radius:14px}.mobilebar{display:none}.floating-bot{display:none!important}.rightbar{display:none}
@media(max-width:980px){.layout{grid-template-columns:1fr;padding:0 10px}.sidebar{position:relative;top:0;max-height:none}.v2-topbar{padding:10px 12px}h1{font-size:26px}.analytics-row{grid-template-columns:1fr}.top-hero,.panel{padding:16px;border-radius:22px}.premium-title{font-size:24px}}
@media(max-width:640px){body{font-size:13px}.sidebar{border-radius:22px}.v2-nav-link{grid-template-columns:26px 1fr auto}.app-quick-grid,.module-hub,.grid,.premium-grid-pro{grid-template-columns:1fr}.hero-actions button{width:100%}input,select,textarea,button{font-size:13px}.payment-body{padding:14px}}
</style>
...
def save_support_message(device_id, sender, message):
    ...
    c.execute("INSERT INTO support_messages(device_id,sender,message,status,created_at) VALUES(?,?,?,?,?)",
              ((device_id or get_device_id()).strip().upper(), sender, (message or '').strip(), 'new', now))
    conn.commit(); conn.close()

def get_support_messages(limit=100, device_id=None):
    ensure_support_table()
    conn = db(); c = conn.cursor()
    if device_id:
        c.execute("SELECT id,device_id,sender,message,created_at FROM support_messages WHERE device_id=? ORDER BY id ASC LIMIT ?", ((device_id or '').strip().upper(), limit))
    else:
        c.execute("SELECT id,device_id,sender,message,created_at FROM support_messages ORDER BY id DESC LIMIT ?", (limit,))
    rows = c.fetchall(); conn.close(); return rows
...
@app.route("/admin")
def admin_home():
    return render_template_string(ADMIN_HTML, rows=get_premium_requests(), support_rows=get_support_messages(100))
...
def support_send_route():
    ...
    if not message:
        return jsonify({"ok": False, "message": "Vui lòng nhập nội dung cần hỗ trợ."}), 400
    full_message = message
    if phone or email:
        full_message = f"{message}\nSĐT/Zalo: {phone or 'Chưa nhập'}\nEmail: {email or 'Chưa nhập'}"
    save_support_message(device_id, "customer", full_message)
    return jsonify({"ok": True, "message": "Đã gửi cho Admin. Kỹ thuật sẽ phản hồi ngay trong khung chat."})

@app.route("/support_poll")
def support_poll_route():
    device_id = (request.args.get("device_id") or get_device_id()).strip().upper()
    rows = get_support_messages(100, device_id=device_id)
    return jsonify({"ok": True, "messages": [{"id": r[0], "device_id": r[1], "sender": r[2], "message": r[3], "created_at": r[4]} for r in rows]})
...
def pwa_icon_route():
    # PNG 1x1 trong suốt để PWA không lỗi thiếu icon; có thể thay bằng logo thật sau.
    import base64
